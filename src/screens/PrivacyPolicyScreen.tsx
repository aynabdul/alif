...
import { useAuthStore } from '../stores/authStore'; // Assuming this is where user context is managed

const PrivacyPolicyScreen = () => {
  const { theme } = useTheme();
  const { user } = useAuthStore(); // Assuming authStore provides user data
  const country = user?.country || 'PK'; // Fallback to 'PK' if country is not available
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
          ...
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            Alif Farms. (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by Alif Farms.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            This Privacy Policy applies to our website, www.aliffarms.com, and its associated subdomains (collectively, our “Service”).
          </Text>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Definitions and Key Terms</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>Cookie:</Text> Small amount of data generated by a website and saved by your web browser. It is used to identify your browser, provide analytics, remember information about you such as your language preference or login information.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>Company:</Text> When this policy mentions “Company,” “we,” “us,” or “our,” it refers to Alif Farms (Private) Limited, {country === 'PK' ? 'GF2V+X39, road, near pangali stop padri, Lahore, Pakistan' : '124 Mahoning Dr E, Lehighton, PA 18235, USA'} that is responsible for your information under this Privacy Policy.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>Country:</Text> Where Alif Farms or the owners/founders of Alif Farms are based, in this case is {country === 'PK' ? 'Pakistan' : 'USA'}.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>Customer:</Text> Refers to the company, organization or person that signs up to use the Alif Farms Service to manage the relationships with your consumers or service users.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>Device:</Text> Any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Alif Farms and use the services.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>IP address:</Text> Every device connected to the Internet is assigned a number known as an Internet protocol (IP) address. These numbers are usually assigned in geographic blocks. An IP address can often be used to identify the location from which a device is connecting to the Internet.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>Personnel:</Text> Refers to those individuals who are employed by Alif Farms or are under contract to perform a service on behalf of one of the parties.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>Personal Data:</Text> Any information that directly, indirectly, or in connection with other information – including a personal identification number – allows for the identification or identifiability of a natural person.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>Website:</Text> Alif Farms’s site, which can be accessed via this URL: www.aliffarms.com.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            <Text style={styles.boldText}>Service:</Text> Refers to the service provided by Alif Farms as described in the relative terms (if available) and on this platform. Third-party service: refers to advertisers, contest sponsors, promotional and marketing partners, and others who provide our content or whose products or services we think may interest you.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
            <Text style={styles.boldText}>You:</Text> a person or entity that is registered with Alif Farms to use the Services.
          </Text>

          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>What Information Do We Collect?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
          ...
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>Name / Username</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>Phone Numbers</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>Email Addresses</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>Mailing Addresses</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>Billing Addresses</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>Debit/credit card numbers</Text>

          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>How Do We Use The Information We Collect?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            Any of the information we collect from you may be used in one of the following ways:
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.text }]}>To personalize your experience (your information helps us to better respond to your individual needs)</Text>
          <Text style={[styles.paragraph, { color: theme.colors.text }]}>To improve our service (we continually strive to improve our service offerings based on the information and feedback we receive from you)</Text>
          <Text style={[styles.paragraph, { color: theme.colors.text }]}>To improve customer service (your information helps us to more effectively respond to your customer service requests and support needs)</Text>
          <Text style={[styles.paragraph, { color: theme.colors.text }]}>To process transactions</Text>
          <Text style={[styles.paragraph, { color: theme.colors.text }]}>To administer a contest, promotion, survey or other site feature</Text>
          <Text style={[styles.paragraph, { color: theme.colors.text, marginBottom: 16 }]}>To send periodic emails</Text>

          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>When do we use customer information from third parties?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Do we share the information we collect with third parties?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Where and when is information collected from customers and end users?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>How Do We Use Your Email Address?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Could my information be transferred to other countries?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
            We are incorporated in Pakistan & USA. Information collected via our website, through direct interactions with you, or from use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border transfer and hosting of such information.
          </Text>

          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Is the information collected through our service secure?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
          ...
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>misconduct will be the standards used to measure our compliance with that duty.</Text>

          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Can I update or correct my information?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Personnel</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Sale of Business</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Affiliates</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>How Long Do We Keep Your Information?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>How Do We Protect Your Information?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
            The laws of Pakistan, excluding its conflicts of law rules, shall govern this Agreement and your use of our service. Your use of our service may also be subject to other local, state, national, or international laws.
          </Text>

          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Your Consent</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Cookies</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Kids’ Privacy</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
            We do not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age of 13. If You are a parent or guardian and You are aware that your child has provided us with Personal Data, please contact Us. If We become aware that we have collected Personal Data from anyone under the age of 13 without verification of parental consent, We take steps to remove that information from our servers.
          </Text>

          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Changes To Our Privacy Policy</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Facebook Pixel</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Information about General Data Protection Regulation (GDPR)</Text>
          <Text style={[styles.subSectionTitle, { color: theme.colors.text }]}>Regulation (GDPR)</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
            We may be collecting and using information from you if you are from the European Economic Area (EEA), and in this section of our Privacy Policy we are going to explain exactly how and why is this data collected, and how we maintain this data under protection from being replicated or used in the wrong way.
          </Text>

          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>What is GDPR?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
            GDPR is an EU-wide privacy and data protection law that regulates how EU residents’ data is protected by companies and enhances the control the EU residents have, over their personal data.
          </Text>

          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>What is personal data?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
          ...
          <Text style={[styles.subSectionTitle, { color: theme.colors.text }]}>Why is GDPR important?</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>Individual Data Subject’s Rights – Data Access, Portability and Deletion</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            We are committed to helping our customers meet the data subject rights requirements GDPR. We process or store all personal data in fully vetted, DPA compliant vendors. We do store all conversation and personal data for up to 6 years unless your account is deleted. In which case, we dispose of all data in accordance with our Terms of Service and Privacy Policy, but we will not hold it longer than 60 days.
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 16 }]}>
          ...
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>Don’t hesitate to contact us if you have any questions.</Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary }]}>
            Via Email: <Text style={styles.boldText}>admin@aliffarms.com</Text>
          </Text>
          <Text style={[styles.paragraph, { color: theme.colors.textSecondary, marginBottom: 48 }]}>
            Via Phone Number: <Text style={styles.boldText}>{country === 'PK' ? '0305-2023333' : '(888)321-ALIF'}</Text>
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  boldText: {
    fontWeight: '600',
    fontSize: 14,
    color: '#37474F', // Matches web's text-gray-800/text-gray-700
  },
});
